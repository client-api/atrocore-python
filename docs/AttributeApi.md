# clientapi_atrocore.AttributeApi

All URIs are relative to *https://demo.atropim.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_relation_for_attribute**](AttributeApi.md#add_relation_for_attribute) | **POST** /Attribute/{link}/relation | Add relation for Attribute
[**create_attribute_item**](AttributeApi.md#create_attribute_item) | **POST** /Attribute | Create a record of the Attribute
[**delete_attribute_item**](AttributeApi.md#delete_attribute_item) | **DELETE** /Attribute/{id} | Delete a record of the Attribute
[**follow_attribute**](AttributeApi.md#follow_attribute) | **PUT** /Attribute/{id}/subscription | Follow the Attribute stream
[**get_attribute_item**](AttributeApi.md#get_attribute_item) | **GET** /Attribute/{id} | Returns a record of the Attribute
[**get_linked_items_for_attribute_item**](AttributeApi.md#get_linked_items_for_attribute_item) | **GET** /Attribute/{id}/{link} | Returns linked entities for the Attribute
[**get_list_of_attribute_items**](AttributeApi.md#get_list_of_attribute_items) | **GET** /Attribute | Returns a collection of Attribute records
[**link_attribute**](AttributeApi.md#link_attribute) | **POST** /Attribute/{id}/{link} | Link Attribute to Entities
[**mass_delete_attribute**](AttributeApi.md#mass_delete_attribute) | **POST** /Attribute/action/massDelete | Mass delete of Attribute data
[**mass_update_attribute**](AttributeApi.md#mass_update_attribute) | **PUT** /Attribute/action/massUpdate | Mass update of Attribute data
[**remove_relation_for_attribute**](AttributeApi.md#remove_relation_for_attribute) | **DELETE** /Attribute/{link}/relation | Remove relation for Attribute
[**unfollow_attribute**](AttributeApi.md#unfollow_attribute) | **DELETE** /Attribute/{id}/subscription | Unfollow the Attribute stream
[**unlink_attribute**](AttributeApi.md#unlink_attribute) | **DELETE** /Attribute/{id}/{link} | Unlink Attribute from Entities
[**update_attribute_item**](AttributeApi.md#update_attribute_item) | **PUT** /Attribute/{id} | Update a record of the Attribute


# **add_relation_for_attribute**
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_attribute_item_request** | [**CreateAttributeItemRequest**](CreateAttributeItemRequest.md)|  | 
...
# **get_linked_items_for_attribute_item**
...
[**GetListOfAttributeItems200Response**](GetListOfAttributeItems200Response.md)
