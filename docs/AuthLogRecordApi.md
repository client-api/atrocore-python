...
------------- | ------------- | -------------
[**add_relation_for_auth_log_record**](AuthLogRecordApi.md#add_relation_for_auth_log_record) | **POST** /AuthLogRecord/{link}/relation | Add relation for AuthLogRecord
[**create_auth_log_record_item**](AuthLogRecordApi.md#create_auth_log_record_item) | **POST** /AuthLogRecord | Create a record of the AuthLogRecord
[**delete_auth_log_record_item**](AuthLogRecordApi.md#delete_auth_log_record_item) | **DELETE** /AuthLogRecord/{id} | Delete a record of the AuthLogRecord
[**follow_auth_log_record**](AuthLogRecordApi.md#follow_auth_log_record) | **PUT** /AuthLogRecord/{id}/subscription | Follow the AuthLogRecord stream
[**get_auth_log_record_item**](AuthLogRecordApi.md#get_auth_log_record_item) | **GET** /AuthLogRecord/{id} | Returns a record of the AuthLogRecord
[**get_linked_items_for_auth_log_record_item**](AuthLogRecordApi.md#get_linked_items_for_auth_log_record_item) | **GET** /AuthLogRecord/{id}/{link} | Returns linked entities for the AuthLogRecord
[**get_list_of_auth_log_record_items**](AuthLogRecordApi.md#get_list_of_auth_log_record_items) | **GET** /AuthLogRecord | Returns a collection of AuthLogRecord records
[**link_auth_log_record**](AuthLogRecordApi.md#link_auth_log_record) | **POST** /AuthLogRecord/{id}/{link} | Link AuthLogRecord to Entities
[**mass_delete_auth_log_record**](AuthLogRecordApi.md#mass_delete_auth_log_record) | **POST** /AuthLogRecord/action/massDelete | Mass delete of AuthLogRecord data
[**mass_update_auth_log_record**](AuthLogRecordApi.md#mass_update_auth_log_record) | **PUT** /AuthLogRecord/action/massUpdate | Mass update of AuthLogRecord data
[**remove_relation_for_auth_log_record**](AuthLogRecordApi.md#remove_relation_for_auth_log_record) | **DELETE** /AuthLogRecord/{link}/relation | Remove relation for AuthLogRecord
[**unfollow_auth_log_record**](AuthLogRecordApi.md#unfollow_auth_log_record) | **DELETE** /AuthLogRecord/{id}/subscription | Unfollow the AuthLogRecord stream
[**unlink_auth_log_record**](AuthLogRecordApi.md#unlink_auth_log_record) | **DELETE** /AuthLogRecord/{id}/{link} | Unlink AuthLogRecord from Entities
[**update_auth_log_record_item**](AuthLogRecordApi.md#update_auth_log_record_item) | **PUT** /AuthLogRecord/{id} | Update a record of the AuthLogRecord
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_auth_log_record_item_request** | [**CreateAuthLogRecordItemRequest**](CreateAuthLogRecordItemRequest.md)|  | 

### Return type

[**AuthLogRecord**](AuthLogRecord.md)
...
[**GetListOfAuthLogRecordItems200Response**](GetListOfAuthLogRecordItems200Response.md)
