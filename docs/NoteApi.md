...
------------- | ------------- | -------------
[**add_relation_for_note**](NoteApi.md#add_relation_for_note) | **POST** /Note/{link}/relation | Add relation for Note
[**create_note_item**](NoteApi.md#create_note_item) | **POST** /Note | Create a record of the Note
[**delete_note_item**](NoteApi.md#delete_note_item) | **DELETE** /Note/{id} | Delete a record of the Note
[**follow_note**](NoteApi.md#follow_note) | **PUT** /Note/{id}/subscription | Follow the Note stream
[**get_linked_items_for_note_item**](NoteApi.md#get_linked_items_for_note_item) | **GET** /Note/{id}/{link} | Returns linked entities for the Note
[**get_list_of_note_items**](NoteApi.md#get_list_of_note_items) | **GET** /Note | Returns a collection of Note records
[**get_note_item**](NoteApi.md#get_note_item) | **GET** /Note/{id} | Returns a record of the Note
[**link_note**](NoteApi.md#link_note) | **POST** /Note/{id}/{link} | Link Note to Entities
[**mass_delete_note**](NoteApi.md#mass_delete_note) | **POST** /Note/action/massDelete | Mass delete of Note data
[**mass_update_note**](NoteApi.md#mass_update_note) | **PUT** /Note/action/massUpdate | Mass update of Note data
[**remove_relation_for_note**](NoteApi.md#remove_relation_for_note) | **DELETE** /Note/{link}/relation | Remove relation for Note
[**unfollow_note**](NoteApi.md#unfollow_note) | **DELETE** /Note/{id}/subscription | Unfollow the Note stream
[**unlink_note**](NoteApi.md#unlink_note) | **DELETE** /Note/{id}/{link} | Unlink Note from Entities
[**update_note_item**](NoteApi.md#update_note_item) | **PUT** /Note/{id} | Update a record of the Note
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_note_item_request** | [**CreateNoteItemRequest**](CreateNoteItemRequest.md)|  | 
...
[**GetListOfNoteItems200Response**](GetListOfNoteItems200Response.md)
