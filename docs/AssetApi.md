...
------------- | ------------- | -------------
[**add_relation_for_asset**](AssetApi.md#add_relation_for_asset) | **POST** /Asset/{link}/relation | Add relation for Asset
[**create_asset_item**](AssetApi.md#create_asset_item) | **POST** /Asset | Create a record of the Asset
[**delete_asset_item**](AssetApi.md#delete_asset_item) | **DELETE** /Asset/{id} | Delete a record of the Asset
[**follow_asset**](AssetApi.md#follow_asset) | **PUT** /Asset/{id}/subscription | Follow the Asset stream
[**get_asset_item**](AssetApi.md#get_asset_item) | **GET** /Asset/{id} | Returns a record of the Asset
[**get_linked_items_for_asset_item**](AssetApi.md#get_linked_items_for_asset_item) | **GET** /Asset/{id}/{link} | Returns linked entities for the Asset
[**get_list_of_asset_items**](AssetApi.md#get_list_of_asset_items) | **GET** /Asset | Returns a collection of Asset records
[**link_asset**](AssetApi.md#link_asset) | **POST** /Asset/{id}/{link} | Link Asset to Entities
[**mass_delete_asset**](AssetApi.md#mass_delete_asset) | **POST** /Asset/action/massDelete | Mass delete of Asset data
[**mass_update_asset**](AssetApi.md#mass_update_asset) | **PUT** /Asset/action/massUpdate | Mass update of Asset data
[**remove_relation_for_asset**](AssetApi.md#remove_relation_for_asset) | **DELETE** /Asset/{link}/relation | Remove relation for Asset
[**unfollow_asset**](AssetApi.md#unfollow_asset) | **DELETE** /Asset/{id}/subscription | Unfollow the Asset stream
[**unlink_asset**](AssetApi.md#unlink_asset) | **DELETE** /Asset/{id}/{link} | Unlink Asset from Entities
[**update_asset_item**](AssetApi.md#update_asset_item) | **PUT** /Asset/{id} | Update a record of the Asset
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_asset_item_request** | [**CreateAssetItemRequest**](CreateAssetItemRequest.md)|  | 
...
[**GetListOfAssetItems200Response**](GetListOfAssetItems200Response.md)
